...
/* BUSCLK register */
#define CMU_BUSCLK_NOCDIV_2			1
#define CMU_BUSCLK_NOCDIV_SHIFT			19
#define CMU_BUSCLK_NOCDIV_DIV			(CMU_NOCDIV_2 << CMU_NOCDIV_SHIFT)
#define CMU_BUSCLK_DMMCLK_SRC_APLL		2
#define CMU_BUSCLK_DMMCLK_SRC_SHIFT		10
#define CMU_BUSCLK_DMMCLK_SRC			(CMU_DMMCLK_SRC_APLL << CMU_DMMCLK_SRC_SHIFT)
#define CMU_BUSCLK_APBCLK_DIV			BIT(8)
#define CMU_BUSCLK_NOCCLK_SRC			BIT(7)
#define CMU_BUSCLK_AHBCLK_DIV			BIT(4)
